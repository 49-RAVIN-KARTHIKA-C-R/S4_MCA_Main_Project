...
(4,'BIRTHDAY FUNCTIONS','Nil','2022-07-21','no','approved',6),
(5,'ENGAGEMENT','Nil','2022-07-28','no','pending',10),
(6,'BIRTHDAY FUNCTIONS','NIL','2022-08-03','no','pending',8);
...
CREATE TABLE `templeapp_bank` (
  ...
  `user_id_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `templeapp_bank_user_id_id_7a3799f0_fk_templeapp_user_id` (`user_id_id`),
  CONSTRAINT `templeapp_bank_user_id_id_7a3799f0_fk_templeapp_user_id` FOREIGN KEY (`user_id_id`) REFERENCES `templeapp_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `templeapp_bank` */

insert  into `templeapp_bank`(`id`,`bank_name`,`ifsc`,`pin`,`acc_no`,`amount`,`user_id_id`) values 
(1,'SBI','SBI0001',6666,6666,200000,6);
...
(17,'pending','2022-07-14',4,3),
(18,'pending','2022-07-14',1,3),
(19,'pending','2022-07-14',4,4),
(20,'pending','2022-07-14',4,5);
...
(6,'RISHIKESH','M K','SANOOP  M K','M K HOUSE','KANDOTH','','NILESWARAM',671320,8765432189076,7845961237,'rishikesh@gmail.com','Screenshot 2022-07-05 194334_i7vldna.png',16),
